...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"Zilek.sqlite"];
	...
	defaultStorePath = [[NSBundle mainBundle] pathForResource:@"Zilek" ofType:@"sqlite"];
